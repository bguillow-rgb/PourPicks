...
faqs:
  ...
  - q: "What's a high-rye bourbon mash bill?"
    a: "A high-rye bourbon has 20-35% rye in its mash bill, significantly more spice than a traditional bourbon, but still legally bourbon because corn remains the majority grain. Four Roses Single Barrel (35% rye), Bulleit Bourbon (28% rye), and Old Grand-Dad (27% rye) are classic high-rye bourbons. The character reads as spicier and drier than standard bourbons."
  - q: "What is a wheated bourbon?"
    a: "A wheated bourbon uses wheat instead of rye as the secondary 'flavoring' grain in the mash bill. The corn percentage stays the same (or even goes higher), but wheat replaces rye. The result is a softer, sweeter, less spicy bourbon. Maker's Mark (~16% wheat), Weller (~16% wheat), Pappy Van Winkle (~16% wheat), and Larceny are the best-known wheated bourbons."
  - q: "Why does the same distillery's bourbons taste different?"
    a: "Because they're often made from different mash bills. Buffalo Trace Distillery, for example, uses four distinct bourbon mash bills (#1, #2, BTAC wheated, and Weller wheated) plus a rye mash bill. Same yeast, same water, same barrels, same warehouse, but the grain recipe changes, and that changes everything about how the final whiskey tastes."
  - q: "Do distilleries publish their exact mash bills?"
...
## What grains are in a typical bourbon mash bill?
...
## What's the difference between a traditional, high-rye, and wheated mash bill?
...
## Why do mash bills explain so much about flavor?
...
## Why do bourbons from the same distillery taste different?

Because many distilleries run multiple mash bills.

Buffalo Trace Distillery, for example, runs four bourbon mash bills:
- **Mash bill #1** (low-rye, ~10% rye), used for Buffalo Trace, Eagle Rare, Stagg, George T. Stagg, E.H. Taylor
- **Mash bill #2** (high-rye, ~15% rye), used for Blanton's, Elmer T. Lee, Hancock's, Ancient Age
- **Wheated mash bill**, used for Weller, Pappy Van Winkle, Old Fitzgerald
- **BTAC wheated mash bill**, used for William Larue Weller
...
## How do you find out a bourbon's mash bill?
...
## Does mash bill matter more than age?
...
## What's the most useful mash bill knowledge for a beginner?

Memorize three benchmark bottles:

1. **Buffalo Trace** (~78% corn / 10% rye / 12% barley), Low-rye traditional bourbon. This is your baseline; everything else is relative to this.
2. **Four Roses Single Barrel** (60% corn / 35% rye / 5% barley), High-rye bourbon. Notice the spicier finish.
3. **Maker's Mark** (70% corn / 16% wheat / 14% barley), Wheated bourbon. Notice the absence of spice and the rounder sweetness.
...
*Pour Picks tracks mash bills, proof, age, and pairings for thousands of bourbons in its catalog. [Download on the App Store](https://apps.apple.com/us/app/pour-picks/id6764040132) to see what's in the bottle before you pour it.*
