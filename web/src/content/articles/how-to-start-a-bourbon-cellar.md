...
relatedQueries:
  ...
  - "first bottles for a bourbon collection"
  - "bourbon cellar storage"
...
faqs:
  ...
  - q: "Does bourbon go bad once you open it?"
    a: "Bourbon doesn't spoil but oxidation changes the flavor noticeably over six to twelve months once the bottle is opened, especially below the half-full line. Cap tightly, store upright, finish open bottles within a year or transfer to a smaller container to reduce headspace."
...
## What's the right price range for a starter cellar?
...
## How should you store bourbon at home?
...
- **Drink faster.** Finish open bottles within nine to twelve months. This is the cheapest solution and works well for active drinkers.
- **Decant.** When a bottle drops to half, transfer the remaining spirit into a smaller bottle (a 375ml or 200ml empty) to reduce headspace.
- **Use a sealant spray.** Products like Private Preserve replace the air in the bottle with an inert gas. Works well, costs about $12 a can, lasts a long time.
...
## How do you actually track a bourbon cellar?
...
## How do you upgrade from beginner to intermediate?
...
- **Two single barrels** from store picks. Single barrels show you variation; store picks teach you that ABV and barrel character matter as much as the brand.
- **One bottled-in-bond.** 100° proof, four years minimum, single distilling season. The BiB rules force consistency.
- **One independent bottler.** Lost Lantern, Single Cask Nation, or any of the smaller indies. These bottles teach you what raw distillate from interesting sources tastes like before it gets blended into a mainstream label.
- **One scotch or Irish whiskey.** Even bourbon nerds benefit from knowing what the rest of whiskey tastes like. A 12-year Highland scotch ($50-70) widens the palate considerably.
- **Two stretch bottles.** A $75-100 bottle of something you've been curious about. Stagg Jr., E.H. Taylor Barrel Proof, Maker's Mark Cask Strength.
- **Three replacements** for the starter bottles you drank and want to keep around.
...
## When does a cellar become a "collection"?
