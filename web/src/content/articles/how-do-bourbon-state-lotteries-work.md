...
relatedQueries:
  - "how to win bourbon lottery"
  - "allocated bourbon lottery how to enter"
  - "bourbon lottery tips"
  - "how to get allocated bourbon at retail"
  - "Pappy Van Winkle lottery how it works"
quickAnswer: "Bourbon state lotteries are retailer- or state-run drawings that give registered entrants a fair chance to buy highly allocated bottles, like Pappy Van Winkle or George T. Stagg, at the distillery's suggested retail price. Entrants sign up during an entry window, winners are drawn randomly, and winners typically have 24, 72 hours to pay and collect."
...
faqs:
  ...
  - q: "Can I enter multiple bourbon lotteries for the same bottle?"
    a: "Yes, as long as you enter different retailers or systems. Many serious collectors enter every retailer lottery they can find for a given release, since each is an independent drawing. Just be prepared to pay for every bottle you win."
  - q: "What happens if I win a bourbon lottery but can't pick up the bottle?"
    a: "Most retailers give winners a short window, often 24 to 72 hours, to pay and collect. If you miss it, your spot is typically forfeited and the bottle moves to the next winner or goes back into inventory."
...
1. Create an account on your state liquor authority's website if you haven't already.
2. Watch the authority's announcement calendar or subscribe to email alerts for upcoming allocations.
3. During the open entry window (which can be as short as 48 hours) submit your entry for the specific product.
4. Wait for notification. Winners are usually announced by email or within the portal.
5. If you win, visit the designated store within the redemption window (often 48-72 hours) with your winning confirmation and a valid ID. Pay the fixed retail price and collect your bottle.

For retail lotteries:

1. Find out which local stores are receiving an allocation. Follow retailers on social media, join their email lists, and ask directly. Most stores that run lotteries announce them on Instagram or via text club.
2. Sign up during the entry window. Some stores require in-person sign-up; many have moved to Google Forms, Typeform, or their own app. You'll typically provide your name, phone number or email, and sometimes proof of age.
3. The store draws winners and contacts them. Response windows are short. Many stores give winners only 24 hours to confirm before moving to the next name.
4. Come in, pay, and pick up. Bring your ID. Some stores require the same payment method used to enter if a card was collected at sign-up.
...
- Watch release calendars. Community sites and bourbon-focused newsletters publish expected release windows based on historical distillery patterns. Our guide to [how annual bourbon releases work](/articles/how-annual-bourbon-releases-work) covers the broader release calendar logic, which feeds directly into knowing when to expect lottery announcements.
...
- Log what you enter. A tool like [Pour Picks](/bourbon-inventory-app) lets you journal which lotteries you've entered alongside your cellar, so you don't forget a pending win or accidentally over-commit your budget across simultaneous drawings.
