...
relatedQueries:
  ...
  - "what does cask strength mean on bourbon"
...
faqs:
  ...
  - q: "Should I add water to barrel proof bourbon?"
    a: "It's entirely personal. Adding a few drops of water can open up aromas and reduce ethanol heat, revealing flavors that sit underneath the alcohol. Starting neat and adding water incrementally, called 'proofing down', is the collector's standard approach for evaluating a new expression."
  - q: "Does barrel proof bourbon cost more than standard expressions?"
    a: "Usually, yes, but not always dramatically so. The premium reflects smaller batch sizes, more selective barrel picks, and stronger collector demand. Some accessible barrel proof releases (like Elijah Craig Barrel Proof) retail under $80, while rarer expressions can command several hundred dollars or more on the secondary market."
  - q: "Can a barrel proof bourbon come from more than one barrel?"
    a: "Yes. Barrel proof only means the whiskey was not diluted before bottling. It can be a blend of multiple barrels, as long as their proofs match closely. 'Single barrel' is a separate designation indicating the bottle came from exactly one cask."
published: true
---
...
## So what exactly does "barrel proof" mean?
...
## What's the difference between barrel proof, cask strength, and full proof?
...
## Why do collectors specifically seek out barrel proof releases?
...
## Does barrel proof bourbon always come from a single barrel?
...
1. **Entry proof**, bourbon must enter the barrel at no higher than 125 proof by law. A barrel filled closer to 125 will generally exit higher than one filled at 110.
2. **Warehouse position**, upper floors in a rickhouse swing through more extreme temperature cycles, accelerating evaporation of water relative to alcohol and raising proof over time.
3. **Age**, longer aging in Kentucky's climate generally means higher exit proof, since heat drives the water component off faster than ethanol.
4. **Barrel char level**, heavier char creates a carbon layer that filters some compounds back into the wood, subtly affecting both flavor and ABV over long aging periods.
...
## How does the secondary market treat barrel proof releases in 2026?
