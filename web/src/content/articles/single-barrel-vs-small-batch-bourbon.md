...
relatedQueries:
  ...
  - "single barrel bourbon collecting"
  - "small batch vs single barrel whiskey difference"
quickAnswer: "Single barrel bourbon is drawn from exactly one cask and bottled as-is, every bottle is unique. Small batch blends a carefully selected handful of barrels for a consistent, repeatable flavor profile. Single barrel suits collectors chasing rarity and variation; small batch suits those who want a reliable, refined everyday pour."
...
faqs:
  ...
  - q: "Is 'small batch' a legally defined term on a bourbon label?"
    a: "No. Unlike 'straight' or 'bottled-in-bond,' 'small batch' has no legal definition under U.S. federal standards of identity. Some producers use it to mean 10 barrels; others use it for batches of hundreds. Always research the producer's specific process."
...
When you're standing in front of a shelf holding two bottles of the same distillery's bourbon, one labeled *Single Barrel*, one labeled *Small Batch*, at two different price points, the question isn't just academic. It affects what you buy, what you cellar, and ultimately what you pour. Here's how to actually read those labels.

---

## What exactly is a single barrel bourbon?

*A question we hear often:*

Single barrel is exactly what it claims: the bourbon in your bottle came entirely from one specific cask. No blending, no correction with other barrels. It is whiskey drawn entirely from one cask, bottled on its own without blending. Because no two barrels age identically, each barrel is unique, with flavors influenced by factors like the barrel's char level, aging location, and environmental conditions.

That warehouse position matters more than most drinkers realize. Barrels stored on upper floors of a rickhouse experience wider temperature swings, which accelerates the extraction of oak character. Barrels on lower floors age more slowly and often develop softer, fruitier profiles. Neither is universally better; they're just different stories told by the same distillery.

A single barrel typically yields between 150 and 200 bottles, which means when a release sells out, it's genuinely gone. That finitude is exactly why collectors pay attention.

---

## And what does 'small batch' actually mean?
...
For collectors, this also means small batch labels are reproducible. If you open a bottle and love it, there's a reasonable chance the next release tastes very similar. With single barrel, that's not a promise anyone can make.

---

## How do they actually taste different side by side?
...
|---|---|---|
| **Source** | Exactly one cask | Several selected casks, blended |
| **Consistency** | Varies bottle to bottle (across releases) | Consistent across batches |
| **Flavor character** | Distinctive, sometimes polarizing | Balanced, rounded, predictable |
...
## Which one is better for building a collection?
...
## Does water or proof matter when comparing the two styles?
