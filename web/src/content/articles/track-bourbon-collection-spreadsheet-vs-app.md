...
seoTitle: "How to Track a Bourbon Collection: Spreadsheet vs App"
...
relatedQueries:
  - "bourbon collection spreadsheet"
  - "track whiskey collection app"
  - "how to organize bourbon collection"
  - "best way to log bourbon pours"
quickAnswer: "Spreadsheets work for the first 10 to 15 bottles, notebooks for the first 5, and dedicated apps scale past 50. The bottle count where each method quietly fails is consistent across most collectors. The decision is whether you want to log at the moment of pouring or do data entry once a month."
...
faqs:
  ...
  - q: "Do bourbon collectors really use spreadsheets?"
    a: "Yes, most collectors start with one. The bourbon Reddit community frequently shares spreadsheet templates, and there are several public ones with hundreds of downloads. The catch is that most of those spreadsheets are abandoned by their owners six months later, because the friction of opening and updating them at the moment of pouring is too high."
  - q: "What fields should I track for each bottle in my bourbon collection?"
    a: "At minimum: distillery, expression, mash bill style (rye-heavy, wheated, traditional), proof, age statement, purchase price, purchase date, store, date opened, date finished. Most collectors also track tasting notes per pour, a rating (1 to 10 is standard), and any context (gift, store pick batch number, club allocation)."
  - q: "What is the right rating scale for personal bourbon notes?"
    a: "A 1 to 10 scale is the most common because it forces you to commit to a number that is meaningfully different from the bottle next to it. Half-points like 8.5 are allowed but discouraged because they tend to creep up and turn into a 1 to 20 scale within a year. Some collectors use a simple thumbs-up, thumbs-sideways, thumbs-down system to avoid score inflation entirely."
  - q: "Should I log every pour or just every new bottle?"
    a: "Log every new bottle for sure. Logging every pour is optional but valuable. The reason is that your impression of a bottle changes meaningfully across the bottle's lifespan: fresh open, halfway down, last quarter. Collectors who log every pour can look back and notice that they liked a bottle better in month two than in month one, which is information you cannot get from a single per-bottle review."
  - q: "How long do most bourbon collectors stick with their tracking method?"
    a: "Anecdotally, the typical cycle is around six to nine months for a spreadsheet, three to four months for a paper notebook, and indefinitely for an app that survives the first month of use. Apps that fail to survive the first month tend to fail because of friction at the moment of pouring rather than missing features."
  - q: "Is it worth paying for a bourbon cellar app?"
    a: "If you have fewer than 15 bottles and you pour casually, free is fine. If your collection is growing past 25 bottles or you want detailed analytics, the typical $2.99 to $4.99 a month for a paid tier pays for itself in saved time. The question is whether you actually use the app weekly, not whether the features are worth the price on paper."
published: true
---
...
- The "date opened" column has not been updated in a month
- New bottles get entered in a batch on the weekend instead of when bought
- Tasting notes are blank for the last six bottles you tried
- You start a second tab "for tasting notes" and stop using either one
...
- Scan to add. Point your phone at the label, the bottle is in your cellar in three seconds. No typing.
- Per-pour entries with a single tap.
- Search across distillery, mash bill, proof, rating.
- Data views (everything you have opened in the last month, your top 10 by rating, etc).
- Some apps will recommend what to pour from your own shelf based on what you have not poured recently. The cellar-aware recommender is the newest feature in this category.

**What a good cellar app does not do:**

- Replace your judgment. You still have to decide what to buy and what to drink.
- Survive being uninstalled. If you switch phones or quit the app, your data needs to be exportable. Verify before committing.
