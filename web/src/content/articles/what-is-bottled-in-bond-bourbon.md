---
title: "What Is Bottled-in-Bond Bourbon?"
seoTitle: "What Is Bottled-in-Bond Bourbon? A Collector's Guide"
description: "Bottled-in-Bond means 100 proof, one distillery, one season, 4+ years in a bonded warehouse. Learn why BiB matters for collectors, value, and your cellar."
tier: "detail"
targetQuery: "what is bottled in bond bourbon"
relatedQueries:
  - "bottled in bond bourbon meaning"
  - "BiB bourbon explained"
  - "bottled in bond vs straight bourbon"
  - "best bottled in bond bourbon"
  - "bottled in bond bourbon value"
quickAnswer: "Bottled-in-Bond (BiB) bourbon must meet four strict legal rules from the 1897 Bottled-in-Bond Act: produced at one distillery, in one distilling season, aged at least four years in a federally bonded warehouse, and bottled at exactly 100 proof. It's America's oldest quality-assurance standard for whiskey."
...
faqs:
  ...
  - q: "Is Bottled-in-Bond bourbon better quality than regular bourbon?"
    a: "Not automatically, 'better' depends on your palate, but BiB guarantees a higher floor of transparency and authenticity than standard bourbon. The mandatory 100-proof bottling, single-distillery sourcing, and minimum four-year age all provide real structure that many collectors find more trustworthy than vague premium labels."
  - q: "Can rye whiskey or other spirits be Bottled-in-Bond?"
    a: "Yes. The BiB designation applies to any American-made distilled spirit, not just bourbon. Rye whiskey, corn whiskey, and even apple brandy can carry the label if they meet the same four requirements. However, bourbon is by far the most common BiB spirit in practice."
  - q: "Does Bottled-in-Bond bourbon hold its value better for collectors?"
    a: "Heritage BiB releases, particularly Old Fitzgerald BiB decanters and rare Heaven Hill expressions, have shown strong secondary-market appreciation. The combination of a defined production record (single season, single distillery) and collector transparency makes BiB a useful provenance signal when valuing bottles in a cellar."
  - q: "What are some well-known Bottled-in-Bond bourbons worth knowing?"
    a: "Classic and collectible BiB expressions include Old Fitzgerald Bottled-in-Bond (Heaven Hill's biannual decanter releases), Henry McKenna 10-Year BiB, Evan Williams BiB, Henry McKenna Single Barrel BiB, and the broader Heaven Hill BiB lineup. On the rarer end, Parker's Heritage Collection has issued notable BiB expressions that command premium secondary prices."
published: true
---
...
## What does 'Bottled-in-Bond' actually mean, like, legally?
...
## Why did Congress create this law in the first place?
...
## How is BiB different from 'Straight Bourbon'?
...
## Does the 'single season' rule actually matter for flavor?
...
## Which BiB bottles should collectors actually know?
...
## Does BiB bourbon hold its value in a collection?
...
The key factor is rarity within the category. Everyday BiB bottles like Evan Williams stay near retail because they are widely distributed. Limited-release BiB decanters and bonded expressions from shuttered or low-output distilleries are a different story. If you are actively [tracking your bourbon collection's value](https://pourpicks.app/how-to-value-a-bourbon-collection), logging the distilling season and DSP (Distilled Spirits Plant) number from a BiB label gives you stronger provenance documentation than a standard commercial release provides.

---

## Can I taste the difference between BiB and standard bourbon?
...
Beyond proof, the single-season requirement means the grain character and fermentation profile are tightly consistent within a given release, which is why side-by-side comparisons of BiB vintages from the same distillery are one of the most instructive tastings a collector can do. When you journal each pour, noting the season, age, and batch alongside your own nose, palate, and finish observations, patterns emerge that are genuinely hard to spot any other way. [Pour Picks](https://pourpicks.app) lets you do exactly that: log tasting notes per bottle, tag the distillery and proof, and build a private record that grows more useful every pour.

---

## One important caveat: BiB is a floor, not a ceiling
