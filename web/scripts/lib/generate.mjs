...
// AEO-optimized content. Tuned for the Pour Picks vertical.
...
const VERTICAL =
  'bourbon and whiskey collecting — building, organizing, valuing, tasting, and curating a personal bourbon cellar';
const AUDIENCE =
  'adult (21+) bourbon and whiskey collectors who own multiple bottles and want to get more out of their collection';
